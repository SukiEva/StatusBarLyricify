...
public class LrcGetter {
    ...
    public static Lyric getLyric(Context context, Media Media) {
        ...
        String meta = Media.getTitle() + "," + Media.getArtist() + "," +
                Media.getAlbum() + ", " + Media.getDuration();
        ...
        for (ILrcProvider provider : providers) {
            try {
                ILrcProvider.LyricResult lyricResult = provider.getLyric(Media);
